...
class FG_eval {
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    //Add state vector values to fg vector
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
 ...
 size_t n_constraints = N*6;
  ...
  for (int i = 0; i < delta_start; i++) {
    vars_upperbound[i] = std::numeric_limits<double>::lowest();
  ...
  //limits for other state variables

  // Steering angle, given simulator constraints
  ...
  // Acceleration, given simulator constraints
